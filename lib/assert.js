...
const checkResult = (expectedResult, expectedRows, actualResult) => {
  ...
  if (expectedRows) {
    ...
    if(equality) {
      message = `============ StackQL Assert (row count) Successful ============ \n
      Expected Number of Rows: ${expectedRows} \n
      Actual Number of Rows: ${actualResult.length} \n
      `;
    } else {
      message = `============ StackQL Assert (row count) Failed ============ \n
      Expected Number of Rows: ${expectedRows} \n
      Actual Number of Rows: ${actualResult.length} \n
  ...
  if (expectedResult) {
    ...
    if(equality) {
      message = `============ StackQL Assert (expected results) Successful ============`;
    } else {
      message = `============ StackQL Assert (expected results) Failed ============ \n
